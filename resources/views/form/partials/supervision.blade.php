<div class="card">
    ...
    <div class="card-body">
        <div class="form-check form-switch">
            <input name="routine_approval" wire:model="coshhSection.routine_approval" class="form-check-input" type="checkbox">
            <label class="form-check-label" for="routine_approval">Supervisor approves straightforward and routine work</label>
        </div>
        <div class="form-check form-switch">
            <input name="specific_approval" wire:model="coshhSection.specific_approval" class="form-check-input" type="checkbox">
        ...
        <div class="form-check form-switch">
            <input name="personal_supervision" wire:model="coshhSection.personal_supervision" class="form-check-input" type="checkbox">
