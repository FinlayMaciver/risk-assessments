<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-check form-switch">
            <input name="inform_lab_occupants" wire:model="coshhSection.inform_lab_occupants" class="form-check-input" type="checkbox">
        ...
        <div class="form-check form-switch">
            <input name="inform_cleaners" wire:model="coshhSection.inform_cleaners" class="form-check-input" type="checkbox">
            <label class="form-check-label" for="inform_cleaners">Cleaners</label>
        </div>
        <div class="form-check form-switch">
            <input name="inform_contractors" wire:model="coshhSection.inform_contractors" class="form-check-input" type="checkbox">
        ...
        <div class="input-group input-group-sm flex-nowrap">
            ...
            <input name="inform_other" wire:model="coshhSection.inform_other" type="text" class="form-control" placeholder="Other">
        </div>
    </div>
</div>
<br>
