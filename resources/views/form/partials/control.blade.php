<div class="card">
    <div class="card-body">
        <div class="mb-3">
            ...
            <textarea name="control_measures" class="form-control" wire:model="coshhSection.control_measures"></textarea>
        </div>
        @if ($form->type == 'General')
            <div class="mb-3">
                ...
                <textarea name="chemicals_involved" class="form-control" wire:model="coshhSection.chemicals_involved"></textarea>
            </div>
        @endif
        <div class="mb-3">
            ...
            <textarea name="work_site" class="form-control" wire:model="coshhSection.work_site"></textarea>
        </div>
        <div class="mb-3">
            <label for="disposal_methods" class="form-label">
                Disposal methods for materials used and wastes produced (if any)
            </label>
            <textarea name="disposal_methods" class="form-control" wire:model="coshhSection.disposal_methods"></textarea>
        </div>
        <div class="mb-3">
            ...
            <textarea name="further_risks" class="form-control" wire:model="coshhSection.further_risks"></textarea>
        </div>
    </div>
</div>
<br>
